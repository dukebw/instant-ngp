...
class AdamOptimizer {
   public:
    ...
    AdamOptimizer&
    operator=(const AdamOptimizer& arg) {
        m_state = arg.m_state;
...
class RotationAdamOptimizer {
   public:
    RotationAdamOptimizer(float learning_rate,
                          float epsilon = 1e-08f,
                          float beta1 = 0.9f,
                          float beta2 = 0.99f) {
        m_hparams = {learning_rate, epsilon, beta1, beta2};
    ...
    RotationAdamOptimizer&
    operator=(const RotationAdamOptimizer& arg) {
        m_state = arg.m_state;
        m_hparams = arg.m_hparams;
        return *this;
    }
    ...
    void
    step(const Eigen::Vector3f& gradient) {
        ++m_state.iter;
