...
void
compute_mesh_1ring(const tcnn::GPUMemory<Eigen::Vector3f>& verts,
...
#ifdef NGP_GUI
void
draw_mesh_gl(const tcnn::GPUMemory<Eigen::Vector3f>& verts,
...
void
save_density_grid_to_png(const tcnn::GPUMemory<float>& density,
                         const char* filename,
...
void
save_rgba_grid_to_png_sequence(const tcnn::GPUMemory<Eigen::Array4f>& rgba,
                               const char* path,
                               Eigen::Vector3i res3d,
                               bool swap_y_z = true);
