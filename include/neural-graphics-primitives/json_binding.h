...
void
to_json(nlohmann::json& j, const Eigen::MatrixBase<Derived>& mat) {
...
template <typename Derived>
void
from_json(const nlohmann::json& j, Eigen::MatrixBase<Derived>& mat) {
...
template <typename Derived>
void
to_json(nlohmann::json& j, const Eigen::QuaternionBase<Derived>& q) {
    j.push_back(q.w());
    j.push_back(q.x());
    j.push_back(q.y());
    j.push_back(q.z());
...
template <typename Derived>
void
from_json(const nlohmann::json& j, Eigen::QuaternionBase<Derived>& q) {
...
inline void
to_json(nlohmann::json& j, const BoundingBox& box) {
    to_json(j["min"], box.min);
    to_json(j["max"], box.max);
}

inline void
from_json(const nlohmann::json& j, BoundingBox& box) {
    from_json(j.at("min"), box.min);
    from_json(j.at("max"), box.max);
}

inline void
to_json(nlohmann::json& j, const CameraDistortion& dist) {
...
inline void
from_json(const nlohmann::json& j, CameraDistortion& dist) {
    if (j.contains("k1")) {
...
inline void
from_json(const nlohmann::json& j, TrainingXForm& x) {
    from_json(j.at("start"), x.start);
    from_json(j.at("end"), x.end);
}

inline void
to_json(nlohmann::json& j, const TrainingXForm& x) {
    to_json(j["start"], x.start);
    to_json(j["end"], x.end);
}

inline void
to_json(nlohmann::json& j, const NerfDataset& dataset) {
...
inline void
from_json(const nlohmann::json& j, NerfDataset& dataset) {
    ...
    if (j.contains("camera_distortion"))
        from_json(j.at("camera_distortion"), global_metadata.camera_distortion);
    if (j.contains("principal_point"))
        from_json(j.at("principal_point"), global_metadata.principal_point);
    if (j.contains("rolling_shutter"))
        from_json(j.at("rolling_shutter"), global_metadata.rolling_shutter);
    if (j.contains("focal_length"))
        from_json(j.at("focal_length"), global_metadata.focal_length);
