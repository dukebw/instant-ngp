...
template <typename T>
__global__ void
interleave_and_cast_kernel(const uint32_t num_pixels,
                           bool has_alpha,
...
load_exr_to_gpu(int* width, int* height, const char* filename, bool fix_premult) {
    ...
    *height = exr_image.height;
    ...
    if (full_precision) {
        linear_kernel(interleave_and_cast_kernel<float>,
                      0,
                      nullptr,
                      n_pixels,
                      has_alpha,
        ...
        linear_kernel(interleave_and_cast_kernel<__half>,
                      0,
                      nullptr,
                      n_pixels,
                      has_alpha,
